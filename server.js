...
(function() {
  ...
  server = Http.createServer(function(req, resp) {
    var base, dest_url, encoded_url, error, hmac, hmac_digest, query_digest, ref, ref1, ref2, ref3, transferredHeaders, url, url_type, user_agent;
    if (req.method !== 'GET' || req.url === '/') {
      ...
      transferredHeaders = {
        'Via': (ref = req.headers['user-agent']) != null ? ref : user_agent,
        'User-Agent': (ref1 = req.headers['user-agent']) != null ? ref1 : user_agent,
        'Accept': (ref2 = req.headers.accept) != null ? ref2 : 'image/*',
        'Accept-Encoding': (ref3 = req.headers['accept-encoding']) != null ? ref3 : '',
        "X-Frame-Options": default_security_headers["X-Frame-Options"],
        "X-XSS-Protection": default_security_headers["X-XSS-Protection"],
        "X-Content-Type-Options": default_security_headers["X-Content-Type-Options"],
        "Content-Security-Policy": default_security_headers["Content-Security-Policy"]
